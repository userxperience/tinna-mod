...
ReloadTime = 50 --X seconds of reload time
...
EnergyFireCost = 4500 --energy cost each time you shoot
MetalFireCost = 150 --same but with metal instead
AutofireCloseDoorTicks = 1.5*25 --How many ticks until the door closes after you fire (25 is one second)
RoundsEachBurst = 9 --how many shots in a burst
